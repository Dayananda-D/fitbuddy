...
const applyOnSelection = function (element: any) {
  const color = element.currentTarget.childNodes[0].attributes.fill.value;
  if ((element.currentTarget.id != 'abdominals') && (element.currentTarget.id != 'hands')) {
    if (color == '#b80b0b') {
      element.currentTarget.childNodes[0].attributes.fill.value = '#e3bcbc';
      element.currentTarget.childNodes[1].attributes.fill.value = '#e3bcbc';
    } else {
      element.currentTarget.childNodes[0].attributes.fill.value = '#b80b0b';
      element.currentTarget.childNodes[1].attributes.fill.value = '#b80b0b';
    }
  } else if (element.currentTarget.id == 'abdominals') {
    if (color == '#b80b0b') {
      element.currentTarget.childNodes[0].attributes.fill.value = '#e3bcbc';
    } else {
      element.currentTarget.childNodes[0].attributes.fill.value = '#b80b0b';
    }
  } else if (element.currentTarget.id == 'hands') {
    if (color == '#b80b0b') {
      element.currentTarget.childNodes[0].attributes.fill.value = '#e3bcbc';
      element.currentTarget.childNodes[1].attributes.fill.value = '#e3bcbc';
      element.currentTarget.childNodes[2].attributes.fill.value = '#e3bcbc';
      element.currentTarget.childNodes[3].attributes.fill.value = '#e3bcbc';
    } else {
      element.currentTarget.childNodes[0].attributes.fill.value = '#b80b0b';
      element.currentTarget.childNodes[1].attributes.fill.value = '#b80b0b';
      element.currentTarget.childNodes[2].attributes.fill.value = '#b80b0b';
      element.currentTarget.childNodes[3].attributes.fill.value = '#b80b0b';
    }
  }
}
